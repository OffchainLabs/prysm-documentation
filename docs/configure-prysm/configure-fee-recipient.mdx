...
<strong id="footnote-1">1.</strong> See [Nodes and networks](/learn/concepts/nodes-and-networks.mdx)for a quick refresher on the fundamentals of Ethereum nodes. <br /><br />
